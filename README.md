...
To add the form to allow switching from Light to Dark or System, add the file:
`<?php include("darkmode-form.inc"); ?>`

To your page footer, or your sidebar (I use menubar.php, others choose other menuing systems)
